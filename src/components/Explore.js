...
const ExploreMore = () => {
  ...
  const setMyCards = (value) => {
    setCurrentTab(value);
    const result = HomePageExplore.filter((val) => val.tag === value);
  ...
  return (
    <div>
      ...
      {/* Cards Group */}
      <div className=" w-11/12 lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap  lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7 lg:px-0 px-3">
